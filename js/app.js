   ...
   function startTransition() {
    ...
    function barTransition() {
      ...
      d3.select("#approach")
        ...
        .transition()
          .duration(tranTime/2)
          .text("And plot winning game score on the x-axis. We can now focus on the results with the simple thought of; the higher the close game index, the closer the game, the lower the close game index, the more lopsided the game was.")
          .style("opacity",1)
        .transition()
          .delay(tranTime)
          .duration(tranTime/2)
